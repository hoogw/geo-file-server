...
var fs = require('fs'),
    ...
    // **************   geo-file-server   *****************
          ...
          //ecstatic = require('ecstatic'),  // original version

          // warning, must copy past 'ecstatic' from 'node_module' folder,  ( after run npm install )
          //         the latest version of "ecstatic" does not compatible with this http-server, when download .geojson file, request will be denied.  
          ecstatic = require('./ecstatic'),  // customized version 
...
function HttpServer(options) {
  ...
  before.push(ecstatic({
    ...
    handleError: typeof options.proxy !== 'string',
            ...
            // **************   geo-file-server   ***************** 
                    // false: show permission,   true: hide permission
                    hidePermissions : true, 
                      
                    // allow cors, otherwise, map engine use geojson-url to download geojson will get error:  ...has been blocked by CORS policy: No 'Access-Control-Allow-Origin' header is present on the requested resource
                    cors: true
            // **************   end  **************  geo-file-server   *****************
